...
class SalmonNetwork(object):
    ...
    def main(cls, args):
        ...
        print("rejection sampling: " +str(salmon_run.performRejectionSampling(tb, given1, 1000)))
        print("weighted sampling: " + str(salmon_run.performWeightedSampling(tb, given1, 1000)))
