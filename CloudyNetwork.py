...
class CloudyNetwork(object):
    ...
    def main(cls, args):
        ...
        given1[rain]= True
        given1[cloudy]=True
        print("rejection sampling: " +str(cloudnet.performRejectionSampling(wetGrass, given1, 1000)))
        print("weighted sampling: " + str(cloudnet.performWeightedSampling(wetGrass, given1, 1000)))
        print("gibbs sampling: " + str(cloudnet.performGibbsSampling(wetGrass, given1, 1000)))
        #  P(Rain=1|Sprinkler=1) = TODO in writeup
        print("Test 2")
        given2 = {}
        given2[rain]=True
        print("weighted sampling: " + str(cloudnet.performWeightedSampling(sprinkler, given2, 1000)))
        print("rejection sampling: " + str(cloudnet.performRejectionSampling(sprinkler, given2, 1000)))
        print("gibbs sampling: " + str(cloudnet.performGibbsSampling(sprinkler, given2, 1000)))
